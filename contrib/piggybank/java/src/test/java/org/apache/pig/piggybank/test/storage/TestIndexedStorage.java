...
public class TestIndexedStorage {
    ...
    private void createInputFile(PigServer pigServer, String[] inputs, int id, File outputDir) throws IOException {
    ...
    public void testGetNext() throws IOException, InterruptedException {
        ...
        System.out.println("SETTING mapred.task.id: " + taskId.toString()); //remove
