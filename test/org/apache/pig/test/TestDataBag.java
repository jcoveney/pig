...
public class TestDataBag extends junit.framework.TestCase {
   ...
   // force a pre-merge
    ...
    public void testDefaultBagFactory() throws Exception {
        ...
        assertTrue("Expected a default bag", (bag instanceof NewDefaultDataBag));
    ...
    public void testDataBagIterIdempotent() throws Exception {
        ...
        DataBag bg6 = new NewDefaultDataBag();
        processDataBag(bg6, false);
    }
    ...
    public void testSerializeSingleTupleBag() throws Exception {
        ...
        stBag.write(dos);
        NewDefaultDataBag dfBag = new NewDefaultDataBag();
        dfBag.readFields(dis, BinInterSedes.BAG);
