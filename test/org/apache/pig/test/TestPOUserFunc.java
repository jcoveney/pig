...
public class TestPOUserFunc {
	...
	public void algebraicAVG(
		...
		assertEquals(new Double(initialExpectedSum), sum);
		assertEquals(new Long(initialExpectedCount), count);
		...
		assertEquals(new Double(intermedExpectedSum), sum);
		assertEquals(new Long(intermedExpectedCount), count);
		...
		assertEquals(new Double(expectedAvg), output);
