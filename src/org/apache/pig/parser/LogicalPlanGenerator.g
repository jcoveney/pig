...
private WittgensteinLogicalPlanBuilder builder = null;
...
/*
//TODO need to decide on what the analogue of a LogicalPlan is
...
//Todo
public Map<String, Operator> getLogicalOperators() {
...
public LogicalPlanGenerator(TreeNodeStream input, WittgensteinLogicalPlanBuilder builder) {
    this(input, new RecognizerSharedState());
    this.builder = builder;
}
/*
//TODO if we need this, try and separate out the purpose of each piece more clearly
...
: ^( STATEMENT ( alias { $statement::alias = $alias.name; } )? oa = op_clause parallel_clause? )
  {
      LOp op = builder.lookupOperator( $oa.alias );
